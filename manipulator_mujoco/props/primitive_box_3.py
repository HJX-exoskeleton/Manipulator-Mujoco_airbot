...
class Primitive_box_3(object):
    """
    A base class representing a primitive object in a simulation environment.
    """

    def __init__(self, name_body=None, pos_body=None,  # body
        ...
        self._inertial = self._mjcf_model.worldbody.body[0].add("inertial", mass=0.05, pos="0 0 0", **kwargs)
