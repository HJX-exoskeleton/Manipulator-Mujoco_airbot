...
from manipulator_mujoco.robots import AirBotArmNoActuator, AG95, G2F85
from manipulator_mujoco.props import Primitive  # 盒子属性
from manipulator_mujoco.mocaps import Target
from manipulator_mujoco.controllers import OperationalSpaceController


class AirBotNoActuatorEnv(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        self._box = Primitive(type="box", size=[0.02, 0.02, 0.02], pos=[-0.8, 0, 0.02], rgba=[1, 0, 0, 1],
                              friction=[1, 0.3, 0.0001])  # 盒子属性
