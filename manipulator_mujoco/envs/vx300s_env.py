...
from manipulator_mujoco.robots import Vx300sArm
from manipulator_mujoco.props import Primitive_box_1, Primitive_box_2, Primitive_box_3  # 盒子属性
...
class Vx300sEnv(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        self._box_1 = Primitive_box_1(name_body="box_1", pos_body=[-0.4, 0.0, 0.2],  # body
        ...
        self._box_2 = Primitive_box_2(name_body="box_2", pos_body=[-0.4, 0.1, 0.2],  # body
                              diaginertia=[0.002, 0.002, 0.002],  # inertia
        ...
        self._box_3 = Primitive_box_3(name_body="box_3", pos_body=[-0.4, -0.1, 0.2],  # body
                              diaginertia=[0.002, 0.002, 0.002],  # inertia
                              condim="4", type_geom="box", name_geom="box_geom_3", quat_geom=[0.3, 0, 0, 1],  # geom
                              mass_geom=0.01, size_geom=[0.02, 0.02, 0.02], rgba_geom=[0.1, 0.6, 0.2, 1],  # geom
                              friction=[1, 0.005, 0.0001], solimp=[2, 1, 0.01], solref=[0.01, 1])  # geom
    ...
    def reset(self, seed=None, options=None) -> tuple:
        ...
        with self._physics.reset_context():
            ...
            self._physics.bind(self._arm.joints).qpos = [0,
                                                         ...
                                                         0,
                                                         0.024,
                                                         -0.024]  # qpos = "0 -0.96 1.16 0 -0.3 0 0.024 -0.024"

            # put target in a reasonable starting position
            self._target.set_mocap_pose(self._physics, position=[-0.365, 0.0, 0.3], quaternion=[0, 0, 0, 1])
